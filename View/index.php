        ...
        <div class="col l6 m6 s12">
          <div class="card hoverable">
            <div class="card-content">
              ...
              <h6 class="grey-text">Le <?=date('d/m/Y', strtotime($oAnimal->DateNaissance));?></h6>
            </div>
            <div class="card-image waves-effect waves-block waves-light">
    					<img src="<?=ROOT_URL?>static/img/posts/<?= $oAnimal->image ?>" class="activator" alt="<?= $oAnimal->title ?>">
    				</div>
            <div class="card-content">
            ...
            <div class="card-reveal">
    					<span class="card-title grey-text text-darken-4"><?= $oAnimal->title ?><i class="material-icons right">close</i></span>
